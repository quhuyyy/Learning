...
import time
df1 = pd.read_csv('D:/HK1_2024-2025/AI_HCM/BaiToan3/222-dataset-v2.csv')
df2 = pd.read_excel('D:/HK1_2024-2025/AI_HCM/BaiToan3/222-labFinal.xlsx')
...
df=merged_df.drop('labFinalScore',axis=1)
print(df)
# Xuất dữ liệu ra file CSV mới file này là đầy đủ sao khi fake :V 
df.to_csv('D:/HK1_2024-2025/AI_HCM/BaiToan3/data_final.csv', index=False)